...
- <b style="color: Chartreuse;">+ <i style="color: hotpink; font-weight: normal;">operator</i></b>: Used to concatenate 2 strings.
...
- <b style="color: Chartreuse;">substr</b>: Returns substring. It takes 2 parameters - starting index of first character to be copied and length of required substring.
