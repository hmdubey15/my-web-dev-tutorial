...
- <b style="color: Salmon;">`str`.substring(`pos`, `len`)</b>: Gives substring in `str` from `pos` of length `len`.
...
<b style="color:crimson;">NOTE:</b> Trailing commas are not allowed while using rest operator. Below codes will give error:
