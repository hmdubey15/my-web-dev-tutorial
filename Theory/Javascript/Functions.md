...
When you pass arguments to a function using the `spread operator (...)`, each element of the iterable (such as an array or string) is expanded into individual arguments.
