...
- Event handlers registered using event bubbling (by default behavior or by passing false as the third parameter to addEventListener) are invoked during this phase.
