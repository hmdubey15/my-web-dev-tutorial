...
1. The references can’t go in circles. JavaScript will throw an error if we try to assign **proto** in a circle.<br>
...
- <span style="color: Cyan;">Object.getPrototypeOf(obj)</span> – returns the `[[Prototype]]` of `obj`.
