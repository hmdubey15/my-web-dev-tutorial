...
- <b style="color: Salmon;"><span style="color: DeepSkyBlue; font-weight: normal;">elem</span>.querySelectorAll(<span style="color: RoyalBlue; font-weight: normal;">css_selector</span>):</b> Returns all elements inside `elem` matching the given CSS selector. This is a very powerful functionality:
  ...
  - We can get all the elements present on document using `*` css selector - `document.querySelectorAll('*p, h1*')`.
- <b style="color: Salmon;"><span style="color: DeepSkyBlue; font-weight: normal;">elem</span>.querySelector(<span style="color: RoyalBlue; font-weight: normal;">css_selector</span>):</b> Returns the first element for the given CSS selector. Unlike other methods, it gives <span style="color: Fuchsia;">static</span> collection. It’s like a fixed array of elements.
