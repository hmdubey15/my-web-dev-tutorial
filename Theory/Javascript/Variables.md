...
<b style="color: Chartreuse;">JavaScript Initializations are Not Hoisted. That means variable will remain undefined until the line of initialization is reached.</b>
...
2.) It can be declared without initialization.
