...
- <b style="color: Salmon;">`arr`.push(`ele`)</b>: Adds an element at the end. <span style="color: Crimson;">Multiple comma separated values can also be pushed similarly, thus leading to option to push array also using spread operator.</span>
