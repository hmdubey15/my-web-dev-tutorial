...
## All HTML ELEMENTS - https://webdevcheatsheet.web.app/html and https://www.w3schools.com/tags/default.asp
...
**<a href="https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Structuring_content/Table_accessibility">HTML TABLE ACCESSIBILITY</a>**
...
- **Occupies Full Available Width:** By default, block-level elements expand to fill the full width of their parent container (unless a width is explicitly set).
...
- **Margins and Padding:** Horizontal margins and padding can be applied to inline elements, but vertical margins and padding may not affect the layout in the same way as with block elements.
